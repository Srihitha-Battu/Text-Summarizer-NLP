...
df_1 = pd.read_csv("/Users/srihitha/.cache/kagglehub/datasets/cymerunaslam/allthenews/versions/1/articles1.csv")
df_2 = pd.read_csv("/Users/srihitha/.cache/kagglehub/datasets/cymerunaslam/allthenews/versions/1/articles2.csv")
df_3 = pd.read_csv("/Users/srihitha/.cache/kagglehub/datasets/cymerunaslam/allthenews/versions/1/articles3.csv")
...
# Get the top 80 most frequent authors
...
# Your word cloud function and other code
def word_cloud(art):
...
def get_summary(input_text, num_sentences=3):
    # Put the summarization pipeline here
    # For example, reuse your main logic here
    original_sentences, clean_sentences = preprocess(input_text)
    vectors = sentence_vectors(clean_sentences)
    sim_matrix = build_similarity_matrix(vectors)
    scores = rank_sentences(sim_matrix)
    summary = extract_summary(original_sentences, scores, num_sentences)
    return summary
